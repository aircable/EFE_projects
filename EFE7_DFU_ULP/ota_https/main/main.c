...
void run_ota(void *params)
{
  ...
  while( true ){
    ...
    esp_http_client_config_t clientConfig = {
        // our ota location
        .url = "https://drive.google.com/u/0/uc?id=19Ntkvvf74AhkzUla2y1z16YBStm1thNX&export=download",
        //.url = "https://drive.google.com/uc?authuser=0&id=1HQln4CQI55Qh9Yi4Km1Nyl4Hklv9QuqK&export=download", 
